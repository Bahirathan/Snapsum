...
export const CinematicExplainer: React.FC<CinematicExplainerProps> = ({ onStartLearning }) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-zinc-950 border border-black/[0.05] dark:border-zinc-800/60 shadow-[0_32px_80px_rgba(0,0,0,0.08)] dark:shadow-[0_32px_80px_rgba(0,0,0,0.5)] rounded-3xl overflow-hidden font-sans text-neutral-900 dark:text-zinc-100 flex flex-col lg:flex-row transition-all duration-300 max-w-7xl mx-auto scroll-mt-20 my-2 ring-1 ring-black/[0.03] dark:ring-white/[0.03]" id="cinematic-explainer-panel">
      ...
      {/* ========================================================================= */}
      <div className="w-full lg:w-[350px] bg-[#fcfcfd] dark:bg-zinc-900 border-t lg:border-t-0 lg:border-l border-black/[0.05] dark:border-zinc-800/60 p-5 sm:p-7 flex flex-col justify-between overflow-hidden">
